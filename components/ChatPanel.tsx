...
export function ChatPanel() {
  ...
  return (
    <div className="flex flex-col h-[740px] rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-2xl overflow-hidden">
      {/* Header */}
      ...
      <div className="px-4 py-2.5 bg-zinc-950/60 border-b border-zinc-800/80 flex items-center gap-2 overflow-x-auto text-xs">
        ...
        {presetQueries.map((preset, idx) => (
          <button
            ...
            disabled={isLoading}
            className="flex-shrink-0 px-3 py-1 rounded-full bg-zinc-900 hover:bg-zinc-800 hover:text-white border border-zinc-750 text-[11px] text-zinc-300 transition-all active:scale-95 disabled:opacity-50"
          >
            {preset}
          </button>
        ))}
      ...
      <div className="flex-1 p-4 overflow-y-auto space-y-6">
        {messages.map((msg) => (
          ...
          >
            {msg.role === "assistant" && (
              <div className="w-8 h-8 rounded-lg bg-zinc-950 border border-zinc-800 flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div
              className={`max-w-3xl rounded-2xl p-4 text-xs ${
                msg.role === "user"
                  ? "bg-blue-600 text-white shadow-md ml-12"
                  : "bg-zinc-950 border border-zinc-800 text-zinc-200 shadow-xl"
              }`}
            >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3.5 rounded-xl bg-blue-950/30 border border-blue-500/30">
                      <div className="flex items-center gap-2 text-blue-300 font-bold uppercase tracking-wider text-[10px] mb-1">
            ...
            {msg.role === "user" && (
              <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0 mt-1 shadow-sm text-white">
        ...
        {isLoading && (
          <div className="flex gap-3 items-start">
            <div className="w-8 h-8 rounded-lg bg-zinc-950 border border-zinc-800 flex items-center justify-center flex-shrink-0">
      ...
      <div className="p-4 bg-zinc-950 border-t border-zinc-800">
        ...
        >
          <input
            ...
            className="flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-xs text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-600 font-sans"
            disabled={isLoading}
          />
          <button
            type="submit"
            disabled={!inputQuery.trim() || isLoading}
            className="px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center gap-2 shadow-md shadow-blue-600/25 transition-all disabled:opacity-50 active:scale-95"
          >
